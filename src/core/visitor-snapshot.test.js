...
__tracker(\\"assignment\\", \\"x\\", \\"1,0,1,1\\", x) } catch (e) { console.error(e); }"
`);
  });
  ...
  it("Adds a tracking call for complex assignment", function() {
    ...
    expect(result).toMatchInlineSnapshot(`
"try { document.body.innerText = 'hello';

__tracker(\\"assignment\\", \\"document.body.innerText\\", \\"1,0,1,23\\", \\"'hello'\\") } catch (e) { console.error(e); }"
`);
  });
